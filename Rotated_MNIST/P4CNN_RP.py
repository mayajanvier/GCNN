...
# P4MCN Rotation Pooling 
class P4CNN_RP(nn.Module):
    def __init__(self):
        super(P4CNN_RP, self).__init__()
        self.conv1 = P4ConvZ2(1, 10, kernel_size=3,padding=2)
        self.conv2 = P4ConvP4(10, 10, kernel_size=3,padding=2)
        self.conv3 = P4ConvP4(10, 10, kernel_size=3,padding=2)
        self.conv4 = P4ConvP4(10, 10, kernel_size=3,padding=2)
        self.conv5 = P4ConvP4(10, 10, kernel_size=3,padding=2)
        self.conv6 = P4ConvP4(10, 10, kernel_size=3,padding=1)
        self.conv7 = P4ConvP4(10, 10, kernel_size=3,padding=1)
        self.fc1 = nn.Linear(40, 50)
        self.fc2 = nn.Linear(50, 10)

    def forward(self, x):
        x = F.relu(self.conv1(x))
        x = x = plane_group_spatial_max_pooling(x, 2, 2)
